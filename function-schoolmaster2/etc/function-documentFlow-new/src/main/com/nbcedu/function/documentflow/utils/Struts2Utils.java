...
public class Struts2Utils {
	...
	private static HttpServletResponse initResponseHeader(final String contentType, final String... headers) {
		...
		for (String header : headers) {
			String headerName = StringUtil1.substringBefore(header, ":");
			String headerValue = StringUtil1.substringAfter(header, ":");

			if (StringUtil1.equalsIgnoreCase(headerName, HEADER_ENCODING)) {
				encoding = headerValue;
			} else if (StringUtil1.equalsIgnoreCase(headerName, HEADER_NOCACHE)) {
