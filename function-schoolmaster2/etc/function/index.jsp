	...
	<div class="main">
		<div class="module module1">
			...
			<div class="content userinfo">
				<img class="photo" src="${prc}/function/images/photo.jpg" />
				<p class="name">
					王欢&nbsp;<img src="${prc}/function/images/name-bg.png" />
				</p>
				<p class="">身 份：校长</p>
				<p class="">所在学校：史家小学</p>
				<p class="state">
					<img src="${prc}/function/images/xin.png" />&nbsp;认真工作，快乐生活！
				</p>
				<p class="write">
					<textarea></textarea>
				</p>
				...
				<table width="354" height="272" border="0" cellpadding="1"
					...
					<tr>
						<td colspan="2">
							...
							<a class="pointer ts" href="${prc}/function/gzt/kong.html"> 
					...
					<tr>
						<td width="177">
							<a class="pointer" href="${prc}/function/gzt/deyugongzuo.html">
						...
						<td>
							<a class="pointer" href="${prc}/function/gzt/kong.html">
					...
					<tr>
						<td>
							<a class="pointer" href="${prc}/function/gzt/xinxihuagongzuo.html">
						...
						<td>
							<a class="pointer" href="${prc}/function/gzt/houqinweisheng.html">
		...
		<div class="module module2">
			...
			<div class="content">
				<div class="tongtai">
					<a class="pointer" href="${prc}/function/gzt/zongjiehuibao.html">
				...
				<div class="tongtai">
					<a class="pointer" href="${prc}/function/gzt/qingshibaopi.html">
				...
				<div class="tongtai">
					<a class="pointer" href="${prc}/function/gzt/jinjizhongyaoshijianchuli.html">
