var allNums = [
	               ...
	               {
	            	   url:"/sns_sjoa/countWorkbench.action?module=xxdt_1&status=new?userId=" + curUid,
	            	   numId:"zongjie",
	            	   name:"总结汇报关注性工作"
	               },
	               {
	            	   url:"/sns_sjoa/countWorkbench.action?module=xxdt_2&status=new?userId=" + curUid,
	            	   numId:"qingshi",
	            	   name:"请示报批工作"
	               },
	               {
	            	   url:"/sns_sjoa/countWorkbench.action?module=xxdt_3&status=new?userId=" + curUid,
	            	   numId:"jinji",
	            	   name:"紧急重要事件处理"
	               }
               ];
...
var allNews = [
               		{
               			url:"/sns_sjoa/countWorkbench.action?module=ndzx&status=updated?userId=" + curUid,
               			newsId:"hexin",
               			name:"我关注的核心工作"
               		},
               		{
               			url:"/sns_sjoa/countWorkbench.action?module=ndzx_1&status=new?userId=" + curUid,
               			newsId:"deyugongzuo",
               			name:"德育工作"
               		},
               		{
               			url:"/sns_sjoa/countWorkbench.action?module=ndzx_2&status=new?userId=" + curUid,
               			newsId:"deyujiaoyan",
               			name:"教育教研工作"
               		},
               		{
               			url:"/sns_sjoa/countWorkbench.action?module=ndzx_3&status=new?userId=" + curUid,
               			newsId:"xinxihua",
               			name:"信息化工作"
               		},
               		{
               			url:"/sns_sjoa/countWorkbench.action?module=ndzx_4&status=new?userId=" + curUid,
               			newsId:"houqinweisheng",
               			name:"后勤卫生工作"
               				
               		},
               		{
               			url:"/sns_sjoa/countWorkbench.action?module=ndzx_5&status=new?userId=" + curUid,
               			newsId:"dangtuan",
               			name:"党团工作"
               		},
               		{
               			url:"/sns_sjoa/countWorkbench.action?module=ndzx_6&status=new?userId=" + curUid,
               			newsId:"caiwu",
               			name:"财务工作"
               		}
               ];
...
var refLinshi = function (){
	...
	$.post(ctxPath + '/jsonWorkbench.action?module=lssx', function(data) {
		...
		for(var i = 0;i<data.length;i++){
			...
			var aTag = $("<a class='pointer' href='" + curData[i].url + "'></a>");
