...
function changepage(page){
	window.location.href="${prc}/masterDocumentFlow/listUnhandledDocumentTask.action?pagerUtils.pageIndex="+page;
}
</script>
</head>
	<body>
