...
<div class="con_conent fixed">
  ...
  <div class="table_box fixed">
    <div class="nav"> <span>统计时间:</span>
      ...
      <a class="cx" href="javascript:document.forms[0].submit();">查询</a></div>
      <div class="list">
				...
				<c:when test="${status.index%2==0 }">
					<p class="color">
			          	...
			          	<span class="list-ri">的统计分析</span>
			          		<a href="${prc}/scMaster2/toMasterChart_data.action?id=${data.id}"><img src="${prc}/function/img/erro1.png" /></a>
          			</p>
				</c:when>
				<c:otherwise>
					<p>
