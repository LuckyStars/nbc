...
<div class="con_conent fixed">
  ...
  <input type="hidden" name="data.matcher" value="bookSite"/>
  <div class="table_box fixed">
    <div class="nav"> <span>统计时间:</span>
      ...
      <a class="cx" href="javascript:document.forms[0].submit();">查询</a><a href="${prc}/scMaster2/toChart_data.action" style="float:left; margin-top:15px; margin-left:20px; font-size:14px;">去统计</a></div>
      <div class="list">
