  ...
  <div class="right">
    ...
    <div class="right-input">
      ...
      <tr>
        ...
        <td class="lan" align="center"><span class="words"><a href="detailedWorkbench.action?id=${subject.id }" target="_blank">${subject.title }</a></span></td>
