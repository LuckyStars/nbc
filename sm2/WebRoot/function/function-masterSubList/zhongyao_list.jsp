...
<body>
<div class="header">
  <h1 class="logo"><img src="${prc}/function/function-masterSubList/images/logo.png" width="314" height="51" alt="校长工作台" /></h1>
</div>
<div class="main">
  <div class="left">
    <h1 class="nav-title">应用菜单导航</h1>
    <ul class="nav-list">
      <li><a href="#" class="li-blue" id="nav1"><img src="${prc}/function/function-masterSubList/images/nav_01.png" width="16" height="16" />个人办公<span class="cols"></span></a>
  ...
  <div class="right">
    ...
    <div class="right-input">
      ...
      <tr>
        <td>1</td>
        <td class="lan">
        <span class="word">学校检修工程停滞【电教】</span>
        <img src="${prc}/function/function-masterSubList/img/now.png"  class="now"/></td>
        <td>财务部</td>
        <td>刘莉莉</td>
        <td>今天</td>
        ...
        <td>刘莉莉</td>
        <td>今天</td>
        <td><img src="${prc}/function/function-masterSubList/img/right.jpg" /></td>
      </tr>
    </table>
  </div>
</div>
