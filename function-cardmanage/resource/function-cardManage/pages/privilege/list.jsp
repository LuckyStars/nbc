...
<body>
    ...
    <div class="add1" style="height:140px;" >
       	<div class="add-top1" >
           	<p>补卡类型维护</p>
           	<img src="${prc }/function/function-cardManage/image/erro.jpg"  class="close" style="cursor:pointer;"/>
       	</div>
       	<div class="add-down">
			<div class="under">
	...
	<!--弹出层 END-->
	<form action="${prc}/cardManage/add_userPri.action" name="userPriForm" >
...
<script type="text/javascript">
   	$(function () {
       	...
       	$("#popAdd").click(function(){
			...
			$("#userTree").combotree({
				 url:'${prc}/cardManage/tree_userPri.action',
			     multiple:true,
			     cascadeCheck:true,
   	...
   	function deletePri(id){
		if(confirm('确定要删除吗?')){
			location.href="${prc}/cardManage/remove_userPri.action?id=" + id;
		}
   	}
